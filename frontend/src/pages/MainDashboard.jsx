    ...
    return (
        <div className="flex flex-col items-center justify-center p-8">
            <div className="text-center mb-12">
                ...
                <h1 className="text-5xl font-bold text-gray-800">{t('main_dashboard.title')}</h1>
                <p className="text-xl text-gray-600 mt-4">{t('main_dashboard.description_1')}</p>
                <p className="text-xl text-gray-600">{t('main_dashboard.description_2')}</p>
            </div>
            ...
            <div className="flex justify-center space-x-8 w-full max-w-5xl">
                <div className="bg-white p-8 rounded-xl shadow-md text-center flex-1 transition-transform transform hover:scale-105">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800">{t('main_dashboard.portals.patient.title')}</h2>
                    <p className="text-gray-500 mt-2">{t('main_dashboard.portals.patient.description')}</p>
                ...
                <div className="bg-white p-8 rounded-xl shadow-md text-center flex-1 transition-transform transform hover:scale-105">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800">{t('main_dashboard.portals.doctor.title')}</h2>
                    <p className="text-gray-500 mt-2">{t('main_dashboard.portals.doctor.description')}</p>
                ...
                <div className="bg-white p-8 rounded-xl shadow-md text-center flex-1 transition-transform transform hover:scale-105">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800">{t('main_dashboard.portals.pharmacy.title')}</h2>
                    <p className="text-gray-500 mt-2">{t('main_dashboard.portals.pharmacy.description')}</p>
