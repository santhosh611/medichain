    ...
    return (
        <div className="w-full max-w-lg mx-auto bg-white p-8 rounded-xl shadow-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <input type="text" name="hospital_name" value={formData.hospital_name} onChange={handleChange} placeholder={t('superadmin_dashboard.add_hospital_form.hospital_name_placeholder')} className="w-full p-3 border rounded-lg" required />
                <input type="text" name="location" value={formData.location} onChange={handleChange} placeholder={t('superadmin_dashboard.add_hospital_form.location_placeholder')} className="w-full p-3 border rounded-lg" required />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {hospitals.map(hospital => (
                    <div key={hospital._id} className="bg-gray-50 p-6 rounded-lg shadow-inner">
                        <p><strong>{t('superadmin_dashboard.view_hospitals_list.hospital_name')}:</strong> {hospital.hospital_name}</p>
                        <p><strong>{t('superadmin_dashboard.view_hospitals_list.location')}:</strong> {hospital.location}</p>
