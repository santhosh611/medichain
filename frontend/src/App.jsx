        ...
        <Router>
            <div className="min-h-screen bg-gray-100 p-8">
                <Routes>
                    ...
                    <Route path="/admin" element={<AdminPage />} /> {/* New route for AdminPage */}
...
const Home = () => {
    return (
        <div className="flex flex-col items-center justify-center p-8">
            ...
            {/* Public Dashboard and Admin Links */}
            ...
            <div className="absolute bottom-8 left-8">
                <Link to="/admin" className="flex items-center text-gray-600 hover:text-red-500 transition-colors">
...
export default App;PatientPage.jsx